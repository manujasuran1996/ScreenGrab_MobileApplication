...
public class AdminAddProductActivity extends AppCompatActivity
{
    ...
    private void ValidateProductData()
    {
        ...
        {
            Toast.makeText(this, "Ender product name...", Toast.LENGTH_SHORT).show();
        }
        else
        {
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddProductActivity.this, "received product image url successfully...", Toast.LENGTH_SHORT).show();
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(AdminAddProductActivity.this, AdminOptionsActivity.class);
